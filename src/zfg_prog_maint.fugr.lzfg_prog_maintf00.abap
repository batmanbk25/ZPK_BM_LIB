...
FORM GET_DATA_ZVI_BM_COND.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM ZTB_BM_COND WHERE
(VIM_WHERETAB) .
    CLEAR ZVI_BM_COND .
ZVI_BM_COND-MANDT =
ZTB_BM_COND-MANDT .
...
ZVI_BM_COND-HDESC =
ZTB_BM_COND-HDESC .
    SELECT SINGLE * FROM ZTB_BM_COND_NAME WHERE
CONDNM = ZTB_BM_COND-CONDNM .
    IF SY-SUBRC EQ 0.
ZVI_BM_COND-CONDDS =
ZTB_BM_COND_NAME-CONDDS .
    ENDIF.
<VIM_TOTAL_STRUC> = ZVI_BM_COND.
    APPEND TOTAL.
  ENDSELECT.
  SORT TOTAL BY <VIM_XTOTAL_KEY>.
  <STATUS>-ALR_SORTED = 'R'.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZVI_BM_COND .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZVI_BM_COND.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZVI_BM_COND-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM ZTB_BM_COND WHERE
  CONDNM = ZVI_BM_COND-CONDNM AND
  CONDKEY = ZVI_BM_COND-CONDKEY AND
  CONDID = ZVI_BM_COND-CONDID AND
  RTABLE = ZVI_BM_COND-RTABLE AND
  RFIELD = ZVI_BM_COND-RFIELD AND
  RANGID = ZVI_BM_COND-RANGID .
    IF SY-SUBRC = 0.
    DELETE ZTB_BM_COND .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
...
ZVI_BM_COND-HDESC .
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZVI_BM_COND-UPD_FLAG,
STATUS_ZVI_BM_COND-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZVI_BM_COND.
  SELECT SINGLE * FROM ZTB_BM_COND WHERE
CONDNM = ZVI_BM_COND-CONDNM AND
CONDKEY = ZVI_BM_COND-CONDKEY AND
CONDID = ZVI_BM_COND-CONDID AND
RTABLE = ZVI_BM_COND-RTABLE AND
...
ZTB_BM_COND_NAME-CONDDS .
    ELSE.
      CLEAR SY-SUBRC.
      CLEAR ZVI_BM_COND-CONDDS .
    ENDIF.
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZVI_BM_COND USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZVI_BM_COND-CONDNM TO
ZTB_BM_COND-CONDNM .
MOVE ZVI_BM_COND-CONDKEY TO
ZTB_BM_COND-CONDKEY .
MOVE ZVI_BM_COND-CONDID TO
ZTB_BM_COND-CONDID .
MOVE ZVI_BM_COND-RTABLE TO
ZTB_BM_COND-RTABLE .
MOVE ZVI_BM_COND-RFIELD TO
ZTB_BM_COND-RFIELD .
MOVE ZVI_BM_COND-RANGID TO
ZTB_BM_COND-RANGID .
MOVE ZVI_BM_COND-MANDT TO
ZTB_BM_COND-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'ZTB_BM_COND'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN ZTB_BM_COND TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'ZTB_BM_COND'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
...
ENDFORM.
*---------------------------------------------------------------------*
FORM COMPL_ZVI_BM_COND USING WORKAREA.
...
FORM GET_DATA_ZVI_BM_COND_DIM.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM ZTB_BM_COND_DIM WHERE
(VIM_WHERETAB) .
    CLEAR ZVI_BM_COND_DIM .
ZVI_BM_COND_DIM-MANDT =
ZTB_BM_COND_DIM-MANDT .
ZVI_BM_COND_DIM-CONDNM =
ZTB_BM_COND_DIM-CONDNM .
ZVI_BM_COND_DIM-TABNAME =
ZTB_BM_COND_DIM-TABNAME .
ZVI_BM_COND_DIM-FIELDNAME =
ZTB_BM_COND_DIM-FIELDNAME .
ZVI_BM_COND_DIM-DESCR =
ZTB_BM_COND_DIM-DESCR .
ZVI_BM_COND_DIM-KFFLAG =
ZTB_BM_COND_DIM-KFFLAG .
ZVI_BM_COND_DIM-CHFLAG =
ZTB_BM_COND_DIM-CHFLAG .
ZVI_BM_COND_DIM-CHECKTABLE =
ZTB_BM_COND_DIM-CHECKTABLE .
ZVI_BM_COND_DIM-CHECKFIELD =
ZTB_BM_COND_DIM-CHECKFIELD .
ZVI_BM_COND_DIM-DESCF =
ZTB_BM_COND_DIM-DESCF .
ZVI_BM_COND_DIM-LANGF =
ZTB_BM_COND_DIM-LANGF .
    SELECT SINGLE * FROM ZTB_BM_COND_NAME WHERE
CONDNM = ZTB_BM_COND_DIM-CONDNM .
    IF SY-SUBRC EQ 0.
ZVI_BM_COND_DIM-CONDDS =
ZTB_BM_COND_NAME-CONDDS .
    ENDIF.
<VIM_TOTAL_STRUC> = ZVI_BM_COND_DIM.
    APPEND TOTAL.
  ENDSELECT.
  SORT TOTAL BY <VIM_XTOTAL_KEY>.
  <STATUS>-ALR_SORTED = 'R'.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZVI_BM_COND_DIM .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZVI_BM_COND_DIM.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZVI_BM_COND_DIM-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM ZTB_BM_COND_DIM WHERE
  CONDNM = ZVI_BM_COND_DIM-CONDNM AND
  TABNAME = ZVI_BM_COND_DIM-TABNAME AND
  FIELDNAME = ZVI_BM_COND_DIM-FIELDNAME .
    IF SY-SUBRC = 0.
    DELETE ZTB_BM_COND_DIM .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
      READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY> BINARY SEARCH.
      DELETE EXTRACT INDEX SY-TABIX.
...
ZVI_BM_COND_DIM-LANGF .
    IF SY-SUBRC = 0.
    UPDATE ZTB_BM_COND_DIM ##WARN_OK.
    ELSE.
    INSERT ZTB_BM_COND_DIM .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZVI_BM_COND_DIM-UPD_FLAG,
STATUS_ZVI_BM_COND_DIM-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZVI_BM_COND_DIM.
  SELECT SINGLE * FROM ZTB_BM_COND_DIM WHERE
CONDNM = ZVI_BM_COND_DIM-CONDNM AND
TABNAME = ZVI_BM_COND_DIM-TABNAME AND
FIELDNAME = ZVI_BM_COND_DIM-FIELDNAME .
ZVI_BM_COND_DIM-MANDT =
...
ZTB_BM_COND_NAME-CONDDS .
    ELSE.
      CLEAR SY-SUBRC.
      CLEAR ZVI_BM_COND_DIM-CONDDS .
    ENDIF.
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZVI_BM_COND_DIM USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZVI_BM_COND_DIM-CONDNM TO
ZTB_BM_COND_DIM-CONDNM .
MOVE ZVI_BM_COND_DIM-TABNAME TO
ZTB_BM_COND_DIM-TABNAME .
MOVE ZVI_BM_COND_DIM-FIELDNAME TO
ZTB_BM_COND_DIM-FIELDNAME .
MOVE ZVI_BM_COND_DIM-MANDT TO
ZTB_BM_COND_DIM-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'ZTB_BM_COND_DIM'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN ZTB_BM_COND_DIM TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'ZTB_BM_COND_DIM'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
  PERFORM UPDATE_CORR_KEYTAB USING CM_ACTION RETCODE.
  ADD: RETCODE TO RC, 1 TO COUNT.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM COMPL_ZVI_BM_COND_DIM USING WORKAREA.
*      provides (read-only) fields from secondary tables related
*      to primary tables by foreignkey relationships
ZTB_BM_COND_DIM-MANDT =
ZVI_BM_COND_DIM-MANDT .
