FUNCTION VIEWFRAME_ZVI_MC_BUSTABF.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_MC_BUSTABF
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSTABF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_MC_BUSTABF_EXTRACT
TOTAL = ZVI_MC_BUSTABF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSTABF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_MC_BUSTABF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MC_BUSTABF_EXTRACT
TOTAL = ZVI_MC_BUSTABF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_MC_BUSTABF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSTABF'
...
TOTAL = ZVI_MC_BUSTABF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_MC_BUSTABF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_MC_BUSTABF-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSTABF'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_MC_BUSTABF-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MC_BUSTABF_EXTRACT
TOTAL = ZVI_MC_BUSTABF_TOTAL
