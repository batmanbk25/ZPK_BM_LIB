FUNCTION VIEWFRAME_ZVI_MC_BUSKEYM.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_MC_BUSKEYM
*   generation date: 21.04.2015 at 17:19:35 by user TUANBA
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSKEYM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_MC_BUSKEYM_EXTRACT
TOTAL = ZVI_MC_BUSKEYM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSKEYM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_MC_BUSKEYM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MC_BUSKEYM_EXTRACT
TOTAL = ZVI_MC_BUSKEYM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_MC_BUSKEYM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSKEYM'
...
TOTAL = ZVI_MC_BUSKEYM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_MC_BUSKEYM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_MC_BUSKEYM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_MC_BUSKEYM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_MC_BUSKEYM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MC_BUSKEYM_EXTRACT
TOTAL = ZVI_MC_BUSKEYM_TOTAL
