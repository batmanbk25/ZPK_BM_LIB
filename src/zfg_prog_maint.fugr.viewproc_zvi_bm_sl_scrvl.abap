FUNCTION VIEWPROC_ZVI_BM_SL_SCRVL.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_BM_SL_SCRVL
...
ASSIGN ZVI_BM_SL_SCRVL TO <TABLE1>.
ASSIGN *ZVI_BM_SL_SCRVL TO <INITIAL>.
ASSIGN STATUS_ZVI_BM_SL_SCRVL TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_BM_SL_SCRVL.
    ENDIF.
...
*....................................................................*
    ...
    WHEN SAVE.                           " Write data into database
      ...
      IF <STATUS>-UPD_FLAG NE SPACE.
        ...
        ELSE.
          IF SY-SUBRC EQ 0.
PERFORM DB_UPD_ZVI_BM_SL_SCRVL.
          ENDIF.
        ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_BM_SL_SCRVL-UPD_FLAG TO UPDATE_REQUIRED.
