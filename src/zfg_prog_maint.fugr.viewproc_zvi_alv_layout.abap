FUNCTION VIEWPROC_ZVI_ALV_LAYOUT.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_ALV_LAYOUT
...
ASSIGN ZVI_ALV_LAYOUT TO <TABLE1>.
ASSIGN *ZVI_ALV_LAYOUT TO <INITIAL>.
ASSIGN STATUS_ZVI_ALV_LAYOUT TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_ALV_LAYOUT.
    ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_ALV_LAYOUT-UPD_FLAG TO UPDATE_REQUIRED.
