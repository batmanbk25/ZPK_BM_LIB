FUNCTION VIEWFRAME_ZVI_MAP_SELSCR.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_MAP_SELSCR
*   generation date: 27.11.2013 at 23:15:43 by user TUANBA
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_MAP_SELSCR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_MAP_SELSCR_EXTRACT
TOTAL = ZVI_MAP_SELSCR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_MAP_SELSCR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_MAP_SELSCR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MAP_SELSCR_EXTRACT
TOTAL = ZVI_MAP_SELSCR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_MAP_SELSCR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_MAP_SELSCR'
...
TOTAL = ZVI_MAP_SELSCR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_MAP_SELSCR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_MAP_SELSCR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_MAP_SELSCR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_MAP_SELSCR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_MAP_SELSCR_EXTRACT
TOTAL = ZVI_MAP_SELSCR_TOTAL
