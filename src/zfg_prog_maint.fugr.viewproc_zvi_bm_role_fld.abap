FUNCTION VIEWPROC_ZVI_BM_ROLE_FLD.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_BM_ROLE_FLD
*   generation date: 02.02.2016 at 10:40:53 by user TUANBA
...
ASSIGN ZVI_BM_ROLE_FLD TO <TABLE1>.
ASSIGN *ZVI_BM_ROLE_FLD TO <INITIAL>.
ASSIGN STATUS_ZVI_BM_ROLE_FLD TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_BM_ROLE_FLD.
    ENDIF.
...
*....................................................................*
    ...
    WHEN SAVE.                           " Write data into database
      ...
      IF <STATUS>-UPD_FLAG NE SPACE.
        ...
        ELSE.
          IF SY-SUBRC EQ 0.
PERFORM DB_UPD_ZVI_BM_ROLE_FLD.
          ENDIF.
        ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_BM_ROLE_FLD-UPD_FLAG TO UPDATE_REQUIRED.
