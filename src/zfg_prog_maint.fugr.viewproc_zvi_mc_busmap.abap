FUNCTION VIEWPROC_ZVI_MC_BUSMAP.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_MC_BUSMAP
*   generation date: 26.04.2015 at 18:31:11 by user TUANBA
...
ASSIGN ZVI_MC_BUSMAP TO <TABLE1>.
ASSIGN *ZVI_MC_BUSMAP TO <INITIAL>.
ASSIGN STATUS_ZVI_MC_BUSMAP TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_MC_BUSMAP.
    ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_MC_BUSMAP-UPD_FLAG TO UPDATE_REQUIRED.
