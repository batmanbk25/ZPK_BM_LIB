FUNCTION ZFM_DATA_GET_FIELD_BLANK.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"     REFERENCE(T_FIELD_BLANK) TYPE  LVC_T_FCAT
*"  EXCEPTIONS
*"      NO_STRUCTURE
*"--------------------------------------------------------------------
DATA:
...
* Init
  CLEAR: E_FIRST_FIELD, T_FIELD_BLANK[].
...
* Get table name and field category
  ...
  LOOP AT LT_FIELDCAT INTO LS_FIELDCAT.
    ASSIGN COMPONENT LS_FIELDCAT-FIELDNAME OF STRUCTURE I_DATA
      TO <LF_FIELD_VALUE>.
    IF SY-SUBRC IS INITIAL AND <LF_FIELD_VALUE> IS INITIAL.
      APPEND LS_FIELDCAT TO T_FIELD_BLANK.
