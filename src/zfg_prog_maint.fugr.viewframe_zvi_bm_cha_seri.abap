*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_BM_CHA_SERI
*   generation date: 25.01.2018 at 14:48:55
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_BM_CHA_SERI     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_CHA_SERI'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_CHA_SERI_EXTRACT
TOTAL = ZVI_BM_CHA_SERI_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_CHA_SERI'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_CHA_SERI-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_CHA_SERI_EXTRACT
TOTAL = ZVI_BM_CHA_SERI_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_CHA_SERI-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_CHA_SERI'
...
TOTAL = ZVI_BM_CHA_SERI_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_CHA_SERI-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_CHA_SERI-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_CHA_SERI'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_BM_CHA_SERI-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_CHA_SERI_EXTRACT
TOTAL = ZVI_BM_CHA_SERI_TOTAL
