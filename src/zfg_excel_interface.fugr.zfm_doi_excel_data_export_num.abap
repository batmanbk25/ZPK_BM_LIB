FUNCTION ZFM_DOI_EXCEL_DATA_EXPORT_NUM.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
DATA:
    ...
    LT_EXCEL_DATA   TYPE ZTT_EXCEL_NUMBR,
    LT_EXCEL_DATA2  TYPE SOI_GENERIC_TABLE,
    LS_EXCEL_DATA2  TYPE SOI_GENERIC_ITEM,
...
*    <LF_EXCEL_DATA> TYPE SOI_GENERIC_ITEM,
    <LF_EXCEL_DATA> TYPE ZST_EXCEL_NUMBR.
...
* Change demension row
  LOOP AT LT_EXCEL_DATA ASSIGNING <LF_EXCEL_DATA>.
    ...
    <LF_EXCEL_DATA>-COLUMN  = <LF_EXCEL_DATA>-COLUMN -
                              LS_DIMENS-COLUMN + 1.
    MOVE-CORRESPONDING <LF_EXCEL_DATA> to LS_EXCEL_DATA2.
    CONDENSE: LS_EXCEL_DATA2-ROW, LS_EXCEL_DATA2-COLUMN.
    append LS_EXCEL_DATA2 to LT_EXCEL_DATA2.
  ENDLOOP.
