FUNCTION VIEWPROC_ZVI_BM_PROG_ROLE.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_BM_PROG_ROLE
*   generation date: 02.02.2016 at 16:43:42 by user TUANBA
...
ASSIGN ZVI_BM_PROG_ROLE TO <TABLE1>.
ASSIGN *ZVI_BM_PROG_ROLE TO <INITIAL>.
ASSIGN STATUS_ZVI_BM_PROG_ROLE TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_BM_PROG_ROLE.
    ENDIF.
...
*....................................................................*
    ...
    WHEN SAVE.                           " Write data into database
      ...
      IF <STATUS>-UPD_FLAG NE SPACE.
        ...
        ELSE.
          IF SY-SUBRC EQ 0.
PERFORM DB_UPD_ZVI_BM_PROG_ROLE.
          ENDIF.
        ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_BM_PROG_ROLE-UPD_FLAG TO UPDATE_REQUIRED.
