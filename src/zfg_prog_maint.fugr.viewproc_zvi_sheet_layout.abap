FUNCTION VIEWPROC_ZVI_SHEET_LAYOUT.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_SHEET_LAYOUT
...
ASSIGN ZVI_SHEET_LAYOUT TO <TABLE1>.
ASSIGN *ZVI_SHEET_LAYOUT TO <INITIAL>.
ASSIGN STATUS_ZVI_SHEET_LAYOUT TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_SHEET_LAYOUT.
    ENDIF.
...
*....................................................................*
    ...
    WHEN SAVE.                           " Write data into database
      ...
      IF <STATUS>-UPD_FLAG NE SPACE.
        ...
        ELSE.
          IF SY-SUBRC EQ 0.
PERFORM DB_UPD_ZVI_SHEET_LAYOUT.
          ENDIF.
        ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_SHEET_LAYOUT-UPD_FLAG TO UPDATE_REQUIRED.
