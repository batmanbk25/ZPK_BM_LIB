...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_DF_TYPLS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_DF_TYPLS_EXTRACT
TOTAL = ZVI_BM_DF_TYPLS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_DF_TYPLS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_DF_TYPLS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_DF_TYPLS_EXTRACT
TOTAL = ZVI_BM_DF_TYPLS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_DF_TYPLS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_DF_TYPLS'
...
TOTAL = ZVI_BM_DF_TYPLS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_DF_TYPLS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_DF_TYPLS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_DF_TYPLS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_BM_DF_TYPLS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_DF_TYPLS_EXTRACT
TOTAL = ZVI_BM_DF_TYPLS_TOTAL
