FUNCTION VIEWPROC_ZVI_PROG_PRSV.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_PROG_PRSV
*   generation date: 28.10.2014 at 10:44:55 by user TUANBA
...
ASSIGN ZVI_PROG_PRSV TO <TABLE1>.
ASSIGN *ZVI_PROG_PRSV TO <INITIAL>.
ASSIGN STATUS_ZVI_PROG_PRSV TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_PROG_PRSV.
    ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_PROG_PRSV-UPD_FLAG TO UPDATE_REQUIRED.
