FUNCTION VIEWPROC_ZVI_PROG_PRSF.
*"--------------------------------------------------------------------
*"*"Global Interface:
*"  IMPORTING
...
*"--------------------------------------------------------------------
*---------------------------------------------------------------------*
*    program for:   VIEWPROC_ZVI_PROG_PRSF
...
ASSIGN ZVI_PROG_PRSF TO <TABLE1>.
ASSIGN *ZVI_PROG_PRSF TO <INITIAL>.
ASSIGN STATUS_ZVI_PROG_PRSF TO <STATUS>.
...
*----------------------------------------------------------------------*
  IF FCODE EQ READ OR FCODE EQ READ_AND_EDIT.
    ...
    ELSE.
PERFORM GET_DATA_ZVI_PROG_PRSF.
    ENDIF.
...
*.......................................................................
  ENDCASE.
MOVE STATUS_ZVI_PROG_PRSF-UPD_FLAG TO UPDATE_REQUIRED.
